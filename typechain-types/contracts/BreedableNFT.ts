...
export type CreatureStructOutput = [BigNumber, BigNumber, BigNumber] & {
  tokenId: BigNumber;
  genes: BigNumber;
...
export interface BreedableNFTInterface extends utils.Interface {
  functions: {
    ...
    "getChildGenes(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getChildGenes",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "BredByBirth(uint256,uint256,uint256)": EventFragment;
...
export interface BreedableNFT extends BaseContract {
  ...
  functions: {
    ...
    getChildGenes(
      fatherGenes: BigNumberish,
      motherGenes: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    mintPromo(genes: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "BredByBirth(uint256,uint256,uint256)"(
